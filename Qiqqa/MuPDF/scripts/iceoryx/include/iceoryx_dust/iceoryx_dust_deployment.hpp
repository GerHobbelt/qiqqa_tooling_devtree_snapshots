...
namespace build
{
constexpr uint64_t IOX_MAX_NAMED_PIPE_MESSAGE_SIZE = static_cast<uint64_t>(8192 /* @IOX_MAX_NAMED_PIPE_MESSAGE_SIZE@ */);
constexpr uint32_t IOX_MAX_NAMED_PIPE_NUMBER_OF_MESSAGES =
    static_cast<uint32_t>(32 /* @IOX_MAX_NAMED_PIPE_NUMBER_OF_MESSAGES@ */ );
} // namespace build
} // namespace iox
