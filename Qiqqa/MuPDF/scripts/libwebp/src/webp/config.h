...
/* #define HAVE_WINCODEC_H 1 -- yeah, we have wincodec on Windows, but that COM-based and *that* requires a working Message Pump or you're toast! Guess what CLI applications DO NOT have! */
