...
void
fz_write_pixmap_as_jpx(fz_context *ctx, fz_output *out, const fz_pixmap *pix, int q)
{
...
void
fz_save_pixmap_as_jpx(fz_context *ctx, const fz_pixmap *pixmap, const char *filename, int q)
{
...
static fz_buffer *
jpx_from_pixmap(fz_context *ctx, const fz_pixmap *pix, fz_color_params color_params, int quality, int drop)
{
	fz_buffer *buf = NULL;
	fz_output *out = NULL;
...
fz_buffer *
fz_new_buffer_from_image_as_jpx(fz_context *ctx, const fz_image *image, fz_color_params color_params, int quality)
{
...
fz_buffer *
fz_new_buffer_from_pixmap_as_jpx(fz_context *ctx, const fz_pixmap *pix, fz_color_params color_params, int quality)
{
