...
void
fz_load_bmp_info(fz_context *ctx, const unsigned char *p, size_t total, int *wp, int *hp, int *xresp, int *yresp, fz_colorspace **cspacep, uint8_t* orientation)
{
	fz_load_bmp_info_subimage(ctx, p, total, wp, hp, xresp, yresp, cspacep, orientation, 0);
}
