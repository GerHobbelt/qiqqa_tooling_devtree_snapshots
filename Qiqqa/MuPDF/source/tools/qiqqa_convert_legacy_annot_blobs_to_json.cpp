...
// to the new format; it also serves as a *library* providing this feature in any larger
...
static const char *app = "qcvtannotblob";


static void usage(void)
{
	fz_info(ctx,
		"%s: convert lecagy Qiqqa binary encoded annotation blobs from the database to generally usable JSON format.\n"
		"\n"
...
extern "C" int
qiqqa_convert_legacy_annot_blobs_main(int argc, const char** argv)
{
	int verbosity = 0;
	int c;
