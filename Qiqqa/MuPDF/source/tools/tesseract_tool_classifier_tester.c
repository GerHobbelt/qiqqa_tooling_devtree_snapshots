/*
 * tesseract_classifier_tester_main CLI
 */
...
int main(int argc, const char** argv)
{
	...
	//fz_info(ctx, "usage: tesseract_classifier_tester_main <command> [options]");
	int rv = tesseract_classifier_tester_main(argc, argv);
