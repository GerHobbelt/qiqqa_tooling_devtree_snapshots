...
static void
pdf_opcount_Tj(fz_context *ctx, pdf_processor *proc, const char *str, size_t len)
{
	pdf_opcount_processor *p = (pdf_opcount_processor*)proc;
	size_t z = p->buffer->len;
...
static void
pdf_opcount_squote(fz_context *ctx, pdf_processor *proc, const char *str, size_t len)
{
	pdf_opcount_processor *p = (pdf_opcount_processor*)proc;
	size_t z = p->buffer->len;
...
static void
pdf_opcount_dquote(fz_context *ctx, pdf_processor *proc, float aw, float ac, const char *str, size_t len)
{
	pdf_opcount_processor *p = (pdf_opcount_processor*)proc;
	size_t z = p->buffer->len;
...
pdf_new_opcount_filter(
	...
	void *options_)
{
	pdf_opcount_processor *proc = (pdf_opcount_processor *)pdf_new_processor(ctx, sizeof * proc);
