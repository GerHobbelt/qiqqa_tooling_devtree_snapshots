/*
 * tesseract_set_unicharset_properties_main CLI
 */
...
int main(int argc, const char** argv)
{
	...
	//fz_info(ctx, "usage: tesseract_set_unicharset_properties_main <command> [options]");
	int rv = tesseract_set_unicharset_properties_main(argc, argv);
