/*
 * tesseract_unicharset_extractor_main CLI
 */
...
int main(int argc, const char** argv)
{
	...
	//fz_info(ctx, "usage: tesseract_unicharset_extractor_main <command> [options]");
	int rv = tesseract_unicharset_extractor_main(argc, argv);
