...
static const char *app = "cvt_expedition2json";


static void usage(void)
{
	fz_info(ctx,
		"%s: Convert legacy qiqqa expedition files to generally usable JSON format.\n"
		"\n"
...
extern "C" int
qiqqa_convert_legacy_expedition_main(int argc, const char** argv)
{
	int verbosity = 0;
	int c;
