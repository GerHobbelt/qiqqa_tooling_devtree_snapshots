...
static const char *app = "qcvtconfig2json";


static void usage(void)
{
	fz_info(ctx,
		"%s: Convert legacy Qiqqa configuration file to JSON format.\n"
		"\n"
...
extern "C" int
qiqqa_convert_legacy_configuration_main(int argc, const char** argv)
{
	int verbosity = 0;
	int c;
