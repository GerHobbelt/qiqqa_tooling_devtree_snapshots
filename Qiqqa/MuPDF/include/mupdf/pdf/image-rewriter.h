...
typedef struct
{
	...
	const char *color_lossy_image_recompress_quality;
	const char *color_lossless_image_recompress_quality;
	...
	const char *gray_lossy_image_recompress_quality;
	const char *gray_lossless_image_recompress_quality;
	...
	const char *bitonal_image_recompress_quality;
