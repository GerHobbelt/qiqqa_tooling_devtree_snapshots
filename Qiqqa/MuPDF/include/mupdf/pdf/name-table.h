...
PDF_MAKE_NAME("ClassMap", ClassMap)
...
PDF_MAKE_NAME("Encryption", Encryption)
...
PDF_MAKE_NAME("MarkInfo", MarkInfo)
PDF_MAKE_NAME("Marked", Marked)
...
PDF_MAKE_NAME("TextColor", TextColor)
...
PDF_MAKE_NAME("UseAttachments", UseAttachments)
...
PDF_MAKE_NAME("ViewerPreferences", ViewerPreferences)
PDF_MAKE_NAME("W", W)
PDF_MAKE_NAME("W2", W2)
