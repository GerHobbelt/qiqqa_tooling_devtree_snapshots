...
public:
    ...
    virtual void end_mask(::fz_context *arg_0);
...
public:
    ...
    virtual void seek(::fz_context *arg_0, long long arg_2, int arg_3);
    virtual long long tell(::fz_context *arg_0);
...
public:
    ...
    virtual void op_gs_CA(::fz_context *arg_0, float arg_2);
    virtual void op_gs_SMask(::fz_context *arg_0, ::pdf_obj *arg_2, float *arg_3, int arg_4);
...
private:
    mutable swig::SwigVar_PyObject vtable[88];
#endif
...
public:
    ...
    virtual ::fz_image *image_filter(::fz_context *arg_0, ::fz_matrix arg_2, char const *arg_3, ::fz_image *arg_4);
