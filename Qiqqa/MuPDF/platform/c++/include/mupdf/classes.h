...
struct FzBuffer
{
	...
	*/
	...
	FZ_FUNCTION FzBuffer(const FzPixmap& pixmap, const FzColorParams& color_params, int quality);
	...
	*/
	...
	This method has out-params. Python/C# wrappers look like:
		`fz_new_display_list_from_svg(const char *base_uri, ::fz_archive *zip)` => `(fz_display_list *, float w, float h)`
	 */
	/**
		Parse an SVG document into a display-list.
	*/
	FZ_FUNCTION FzDisplayList fz_new_display_list_from_svg(const char *base_uri, const FzArchive& zip, float *w, float *h) const;
	...
	*/
	FZ_FUNCTION FzImage fz_new_image_from_svg(const char *base_uri, const FzArchive& zip) const;
	...
	*/
	...
	FZ_FUNCTION PdfProcessor pdf_new_buffer_processor(int ahxencode) const;
...
struct FzCompressedBuffer
{
	...
	*/
	...
	/** This class is not copyable or assignable. */
	FzCompressedBuffer(const FzCompressedBuffer& rhs);
	FzCompressedBuffer& operator=(const FzCompressedBuffer& rhs);
};
...
struct FzDevice
{
	...
	*/
	...
	FZ_FUNCTION void fz_begin_structure(::fz_structure standard, const char *raw, int uid) const;
...
struct FzDevice2 : FzDevice
{
	...
	FZ_FUNCTION virtual void close_device(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void drop_device(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void fill_path(struct ::fz_context *arg_0, const struct ::fz_path *arg_2, int arg_3, ::fz_matrix arg_4, struct ::fz_colorspace *arg_5, const float *arg_6, float arg_7, ::fz_color_params arg_8);
	FZ_FUNCTION virtual void stroke_path(struct ::fz_context *arg_0, const struct ::fz_path *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, struct ::fz_colorspace *arg_5, const float *arg_6, float arg_7, ::fz_color_params arg_8);
	FZ_FUNCTION virtual void clip_path(struct ::fz_context *arg_0, const struct ::fz_path *arg_2, int arg_3, ::fz_matrix arg_4, ::fz_rect arg_5);
	FZ_FUNCTION virtual void clip_stroke_path(struct ::fz_context *arg_0, const struct ::fz_path *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, ::fz_rect arg_5);
	FZ_FUNCTION virtual void fill_text(struct ::fz_context *arg_0, const ::fz_text *arg_2, ::fz_matrix arg_3, struct ::fz_colorspace *arg_4, const float *arg_5, float arg_6, ::fz_color_params arg_7);
	FZ_FUNCTION virtual void stroke_text(struct ::fz_context *arg_0, const ::fz_text *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, struct ::fz_colorspace *arg_5, const float *arg_6, float arg_7, ::fz_color_params arg_8);
	FZ_FUNCTION virtual void clip_text(struct ::fz_context *arg_0, const ::fz_text *arg_2, ::fz_matrix arg_3, ::fz_rect arg_4);
	FZ_FUNCTION virtual void clip_stroke_text(struct ::fz_context *arg_0, const ::fz_text *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, ::fz_rect arg_5);
	FZ_FUNCTION virtual void ignore_text(struct ::fz_context *arg_0, const ::fz_text *arg_2, ::fz_matrix arg_3);
	FZ_FUNCTION virtual void fill_shade(struct ::fz_context *arg_0, ::fz_shade *arg_2, ::fz_matrix arg_3, float arg_4, ::fz_color_params arg_5);
	FZ_FUNCTION virtual void fill_image(struct ::fz_context *arg_0, struct ::fz_image *arg_2, ::fz_matrix arg_3, float arg_4, ::fz_color_params arg_5);
	FZ_FUNCTION virtual void fill_image_mask(struct ::fz_context *arg_0, struct ::fz_image *arg_2, ::fz_matrix arg_3, struct ::fz_colorspace *arg_4, const float *arg_5, float arg_6, ::fz_color_params arg_7);
	FZ_FUNCTION virtual void clip_image_mask(struct ::fz_context *arg_0, struct ::fz_image *arg_2, ::fz_matrix arg_3, ::fz_rect arg_4);
	FZ_FUNCTION virtual void pop_clip(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void begin_mask(struct ::fz_context *arg_0, ::fz_rect arg_2, int arg_3, struct ::fz_colorspace *arg_4, const float *arg_5, ::fz_color_params arg_6);
	FZ_FUNCTION virtual void end_mask(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void begin_group(struct ::fz_context *arg_0, ::fz_rect arg_2, struct ::fz_colorspace *arg_3, int arg_4, int arg_5, int arg_6, float arg_7);
	FZ_FUNCTION virtual void end_group(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual int begin_tile(struct ::fz_context *arg_0, ::fz_rect arg_2, ::fz_rect arg_3, float arg_4, float arg_5, ::fz_matrix arg_6, int arg_7);
	FZ_FUNCTION virtual void end_tile(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void render_flags(struct ::fz_context *arg_0, int arg_2, int arg_3);
	FZ_FUNCTION virtual void set_default_colorspaces(struct ::fz_context *arg_0, ::fz_default_colorspaces *arg_2);
	FZ_FUNCTION virtual void begin_layer(struct ::fz_context *arg_0, const char *arg_2);
	FZ_FUNCTION virtual void end_layer(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void begin_structure(struct ::fz_context *arg_0, ::fz_structure arg_2, const char *arg_3, int arg_4);
	FZ_FUNCTION virtual void end_structure(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void begin_metatext(struct ::fz_context *arg_0, ::fz_metatext arg_2, const char *arg_3);
	FZ_FUNCTION virtual void end_metatext(struct ::fz_context *arg_0);
};
...
struct FzDisplayList
{
	...
	*/
	...
	/**
		Parse an SVG document into a display-list.
	*/
	FZ_FUNCTION FzDisplayList(const FzBuffer& buf, const char *base_uri, const FzArchive& zip, float *w, float *h);

	/** Constructor using `fz_new_display_list_from_svg_xml()`. */
	/**
		Parse an SVG document into a display-list.
	*/
	FZ_FUNCTION FzDisplayList(const FzXml& xmldoc, const FzXml& xml, const char *base_uri, const FzArchive& zip, float *w, float *h);
...
struct FzDocument
{
	...
	*/
	FZ_FUNCTION ::fz_bookmark fz_make_bookmark(const FzLocation& loc) const;
	...
	*o_out to length of string plus one. If <key> is not found, returns empty
	...
	error information. */
	FZ_FUNCTION std::string fz_lookup_metadata(const char* key, int* o_out=NULL);
...
struct FzDocumentWriter
{
	...
	*/
	...
	FZ_FUNCTION void fz_write_stabilized_story(const char *user_css, float em, ::fz_write_story_contentfn contentfn, void *contentfn_ref, ::fz_write_story_rectfn rectfn, void *rectfn_ref, ::fz_write_story_pagefn pagefn, void *pagefn_ref, const FzArchive& archive) const;
...
struct FzImage
{
	...
	*/
	FZ_FUNCTION FzImage(int w, int h, int bpc, const FzColorspace& colorspace, int xres, int yres, int interpolate, int imagemask, float *decode, int *colorkey, const FzCompressedBuffer& buffer, const FzImage& mask);
	...
	*/
	...
	/**
		Create a scalable image from an SVG document.
	*/
	FZ_FUNCTION FzImage(const FzBuffer& buf, const char *base_uri, const FzArchive& zip);

	/** Constructor using `fz_new_image_from_svg_xml()`. */
	/**
		Create a scalable image from an SVG document.
	*/
	FZ_FUNCTION FzImage(const FzXml& xmldoc, const FzXml& xml, const char *base_uri, const FzArchive& zip);
	...
	*/
	FZ_FUNCTION FzImage(int w, int h, int bpc, const FzColorspace& colorspace, int xres, int yres, int interpolate, int imagemask, float *decode, int *colorkey, const FzImage& mask, size_t size, ::fz_image_get_pixmap_fn *get_pixmap, ::fz_image_get_size_fn *get_size, ::fz_drop_image_fn *drop);
	...
	*/
	...
	FZ_FUNCTION FzBuffer fz_new_buffer_from_image_as_jpeg(const FzColorParams& color_params, int quality) const;
...
struct FzLinkDest
{
	...
	/** Class-aware wrapper for `::pdf_format_link_uri()`.  */
	FZ_FUNCTION char *pdf_format_link_uri() const;
...
struct FzOutput
{
	...
	*/
	...
	FZ_FUNCTION PdfProcessor pdf_new_output_processor(int ahxencode) const;
	...
	FZ_FUNCTION void pdf_print_encrypted_obj(const PdfObj& obj, int tight, int ascii, const PdfCrypt& crypt, int num, int gen) const;
...
struct FzOutput2 : FzOutput
{
	...
	/** Default virtual method implementations; these all throw an exception. */
	FZ_FUNCTION virtual void write(struct ::fz_context *arg_0, const void *arg_2, unsigned long arg_3);
	FZ_FUNCTION virtual void seek(struct ::fz_context *arg_0, long long arg_2, int arg_3);
	FZ_FUNCTION virtual long long tell(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void close(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void drop(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual struct ::fz_stream * as_stream(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void truncate(struct ::fz_context *arg_0);
};
...
struct FzPage
{
	...
	*/
	...
	FZ_FUNCTION std::vector<FzQuad> fz_search_page(const char* needle, int *hit_mark, int max);
...
struct FzPathWalker2 : FzPathWalker
{
	...
	/** Default virtual method implementations; these all throw an exception. */
	FZ_FUNCTION virtual void moveto(struct ::fz_context *arg_0, float arg_2, float arg_3);
	FZ_FUNCTION virtual void lineto(struct ::fz_context *arg_0, float arg_2, float arg_3);
	FZ_FUNCTION virtual void curveto(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7);
	FZ_FUNCTION virtual void closepath(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void quadto(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5);
	FZ_FUNCTION virtual void curvetov(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5);
	FZ_FUNCTION virtual void curvetoy(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5);
	FZ_FUNCTION virtual void rectto(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5);
};
...
struct FzPixmap
{
	...
	*/
	...
	FZ_FUNCTION FzPixmap(const PdfPage& page, const FzMatrix& ctm, const FzColorspace& cs, const FzSeparations& seps, int alpha, const char *usage);

	/** Constructor using `pdf_new_pixmap_from_page_contents_with_usage()`. */
	FZ_FUNCTION FzPixmap(const PdfPage& page, const FzMatrix& ctm, const FzColorspace& cs, int alpha, const char *usage);
	...
	FZ_FUNCTION static FzPixmap pdf_new_pixmap_from_page_with_usage(const PdfPage& page, const FzMatrix& ctm, const FzColorspace& cs, int alpha, const char *usage);

	/** Class-aware wrapper for `::pdf_new_pixmap_from_page_with_separations_and_usage()`.  */
	FZ_FUNCTION static FzPixmap pdf_new_pixmap_from_page_with_separations_and_usage(const PdfPage& page, const FzMatrix& ctm, const FzColorspace& cs, const FzSeparations& seps, int alpha, const char *usage);
	...
	*/
	...
	FZ_FUNCTION FzBuffer fz_new_buffer_from_pixmap_as_jpeg(const FzColorParams& color_params, int quality) const;
	...
	*/
	...
	FZ_FUNCTION std::vector<unsigned char> fz_md5_pixmap();

	/** Alternative to pixmap_samples() that returns pointer as integer. */
	FZ_FUNCTION long long fz_pixmap_samples_int();

	/** Returns m_internal->samples[offset]. */
	FZ_FUNCTION int fz_samples_get(int offset);

	/** Sets m_internal->samples[offset] to value. */
	FZ_FUNCTION void fz_samples_set(int offset, int value);
...
struct FzStory
{
	...
	FZ_FUNCTION FzStory(const FzBuffer& buf, const char *user_css, float em, const FzArchive& archive);
...
struct FzStream
{
	...
	*/
	FZ_FUNCTION FzStream fz_open_dctd(int color_transform, int l2factor, const FzStream& jpegtables) const;
...
struct FzXml
{
	...
	*/
	...
	This method has out-params. Python/C# wrappers look like:
		`fz_new_display_list_from_svg_xml(::fz_xml *xml, const char *base_uri, ::fz_archive *zip)` => `(fz_display_list *, float w, float h)`
	 */
	/**
		Parse an SVG document into a display-list.
	*/
	FZ_FUNCTION FzDisplayList fz_new_display_list_from_svg_xml(const FzXml& xml, const char *base_uri, const FzArchive& zip, float *w, float *h) const;

	/** Class-aware wrapper for `::fz_new_image_from_svg_xml()`.  */
	/**
		Create a scalable image from an SVG document.
	*/
	FZ_FUNCTION FzImage fz_new_image_from_svg_xml(const FzXml& xml, const char *base_uri, const FzArchive& zip) const;
...
struct PdfDocument
{
	...
	*/
	...
	/** Class-aware wrapper for `::pdf_lookup_anchor()`.
	
	This method has out-params. Python/C# wrappers look like:
		`pdf_lookup_anchor(const char *name)` => `(int, float xp, float yp)`
	 */
	FZ_FUNCTION int pdf_lookup_anchor(const char *name, float *xp, float *yp) const;
	...
	/** Class-aware wrapper for `::pdf_new_destination_from_link()`.  */
	FZ_FUNCTION PdfObj pdf_new_destination_from_link(const char *uri) const;
	...
	/** Class-aware wrapper for `::pdf_parse_link_action()`.  */
	FZ_FUNCTION char *pdf_parse_link_action(const PdfObj& obj, int pagenum) const;

	/** Class-aware wrapper for `::pdf_parse_link_dest()`.  */
	FZ_FUNCTION char *pdf_parse_link_dest(const PdfObj& obj) const;
	...
	*o_out to length of string plus one. If <key> is not found, returns empty
	string with *o_out=-1. <o_out> can be NULL if caller is not interested in
	error information. */
	FZ_FUNCTION std::string pdf_lookup_metadata(const char* key, int* o_out=NULL);
...
struct PdfFilterFactory2 : PdfFilterFactory
{
	...
	/** Default virtual method implementations; these all throw an exception. */
	FZ_FUNCTION virtual struct ::pdf_processor * filter(struct ::fz_context *arg_0, struct ::pdf_document *arg_1, struct ::pdf_processor *arg_2, int arg_3, ::fz_matrix arg_4, struct ::pdf_filter_options *arg_5);
};
...
struct PdfFilterOptions2 : PdfFilterOptions
{
	...
	/** Default virtual method implementations; these all throw an exception. */
	FZ_FUNCTION virtual void complete(struct ::fz_context *arg_0, ::fz_buffer *arg_1);
};
...
struct PdfObj
{
	...
	/** Class-aware wrapper for `::pdf_new_action_from_link()`.  */
	FZ_FUNCTION static PdfObj pdf_new_action_from_link(const PdfDocument& doc, const char *uri);
	...
	FZ_FUNCTION void pdf_page_obj_transform(FzRect& page_mediabox, FzMatrix& page_ctm) const;
...
struct PdfPage
{
	...
	FZ_FUNCTION FzRect pdf_bound_page() const;
	...
	FZ_FUNCTION FzPixmap pdf_new_pixmap_from_page_contents_with_separations_and_usage(const FzMatrix& ctm, const FzColorspace& cs, const FzSeparations& seps, int alpha, const char *usage) const;

	/** Class-aware wrapper for `::pdf_new_pixmap_from_page_contents_with_usage()`.  */
	FZ_FUNCTION FzPixmap pdf_new_pixmap_from_page_contents_with_usage(const FzMatrix& ctm, const FzColorspace& cs, int alpha, const char *usage) const;

	/** Class-aware wrapper for `::pdf_new_pixmap_from_page_with_separations_and_usage()`.  */
	FZ_FUNCTION FzPixmap pdf_new_pixmap_from_page_with_separations_and_usage(const FzMatrix& ctm, const FzColorspace& cs, const FzSeparations& seps, int alpha, const char *usage) const;

	/** Class-aware wrapper for `::pdf_new_pixmap_from_page_with_usage()`.  */
	FZ_FUNCTION FzPixmap pdf_new_pixmap_from_page_with_usage(const FzMatrix& ctm, const FzColorspace& cs, int alpha, const char *usage) const;
...
struct PdfPkcs7Verifier
{
	...
	FZ_FUNCTION int pdf_check_signature(const PdfDocument& doc, const PdfObj& signature, char *ebuf, size_t ebufsize) const;
...
struct PdfProcessor
{
	...
	FZ_FUNCTION PdfProcessor(const FzBuffer& buffer, int ahxencode);

	/** Constructor using `pdf_new_output_processor()`. */
	FZ_FUNCTION PdfProcessor(const FzOutput& out, int ahxencode);
	...
	This method has out-params. Python/C# wrappers look like:
		`pdf_process_contents(::pdf_document *doc, ::pdf_obj *obj, ::pdf_obj *res, ::fz_cookie *cookie, ::pdf_obj **out_res)` => 
	 */
	FZ_FUNCTION void pdf_process_contents(const PdfDocument& doc, const PdfObj& obj, const PdfObj& res, FzCookie& cookie, PdfObj& out_res) const;
...
struct PdfProcessor2 : PdfProcessor
{
	...
	/** Default virtual method implementations; these all throw an exception. */
	FZ_FUNCTION virtual void close_processor(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void drop_processor(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void push_resources(struct ::fz_context *arg_0, struct ::pdf_obj *arg_2);
	FZ_FUNCTION virtual struct ::pdf_obj * pop_resources(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_w(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_j(struct ::fz_context *arg_0, int arg_2);
	FZ_FUNCTION virtual void op_J(struct ::fz_context *arg_0, int arg_2);
	FZ_FUNCTION virtual void op_M(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_d(struct ::fz_context *arg_0, struct ::pdf_obj *arg_2, float arg_3);
	FZ_FUNCTION virtual void op_ri(struct ::fz_context *arg_0, const char *arg_2);
	FZ_FUNCTION virtual void op_i(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_gs_begin(struct ::fz_context *arg_0, const char *arg_2, struct ::pdf_obj *arg_3);
	FZ_FUNCTION virtual void op_gs_BM(struct ::fz_context *arg_0, const char *arg_2);
	FZ_FUNCTION virtual void op_gs_ca(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_gs_CA(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_gs_SMask(struct ::fz_context *arg_0, struct ::pdf_obj *arg_2, float *arg_3, int arg_4);
	FZ_FUNCTION virtual void op_gs_end(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_q(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_Q(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_cm(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7);
	FZ_FUNCTION virtual void op_m(struct ::fz_context *arg_0, float arg_2, float arg_3);
	FZ_FUNCTION virtual void op_l(struct ::fz_context *arg_0, float arg_2, float arg_3);
	FZ_FUNCTION virtual void op_c(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7);
	FZ_FUNCTION virtual void op_v(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5);
	FZ_FUNCTION virtual void op_y(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5);
	FZ_FUNCTION virtual void op_h(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_re(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5);
	FZ_FUNCTION virtual void op_S(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_s(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_F(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_f(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_fstar(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_B(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_Bstar(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_b(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_bstar(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_n(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_W(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_Wstar(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_BT(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_ET(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_Tc(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_Tw(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_Tz(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_TL(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_Tf(struct ::fz_context *arg_0, const char *arg_2, ::pdf_font_desc *arg_3, float arg_4);
	FZ_FUNCTION virtual void op_Tr(struct ::fz_context *arg_0, int arg_2);
	FZ_FUNCTION virtual void op_Ts(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_Td(struct ::fz_context *arg_0, float arg_2, float arg_3);
	FZ_FUNCTION virtual void op_TD(struct ::fz_context *arg_0, float arg_2, float arg_3);
	FZ_FUNCTION virtual void op_Tm(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7);
	FZ_FUNCTION virtual void op_Tstar(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_TJ(struct ::fz_context *arg_0, struct ::pdf_obj *arg_2);
	FZ_FUNCTION virtual void op_Tj(struct ::fz_context *arg_0, char *arg_2, unsigned long arg_3);
	FZ_FUNCTION virtual void op_squote(struct ::fz_context *arg_0, char *arg_2, unsigned long arg_3);
	FZ_FUNCTION virtual void op_dquote(struct ::fz_context *arg_0, float arg_2, float arg_3, char *arg_4, unsigned long arg_5);
	FZ_FUNCTION virtual void op_d0(struct ::fz_context *arg_0, float arg_2, float arg_3);
	FZ_FUNCTION virtual void op_d1(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7);
	FZ_FUNCTION virtual void op_CS(struct ::fz_context *arg_0, const char *arg_2, struct ::fz_colorspace *arg_3);
	FZ_FUNCTION virtual void op_cs(struct ::fz_context *arg_0, const char *arg_2, struct ::fz_colorspace *arg_3);
	FZ_FUNCTION virtual void op_SC_pattern(struct ::fz_context *arg_0, const char *arg_2, ::pdf_pattern *arg_3, int arg_4, float *arg_5);
	FZ_FUNCTION virtual void op_sc_pattern(struct ::fz_context *arg_0, const char *arg_2, ::pdf_pattern *arg_3, int arg_4, float *arg_5);
	FZ_FUNCTION virtual void op_SC_shade(struct ::fz_context *arg_0, const char *arg_2, ::fz_shade *arg_3);
	FZ_FUNCTION virtual void op_sc_shade(struct ::fz_context *arg_0, const char *arg_2, ::fz_shade *arg_3);
	FZ_FUNCTION virtual void op_SC_color(struct ::fz_context *arg_0, int arg_2, float *arg_3);
	FZ_FUNCTION virtual void op_sc_color(struct ::fz_context *arg_0, int arg_2, float *arg_3);
	FZ_FUNCTION virtual void op_G(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_g(struct ::fz_context *arg_0, float arg_2);
	FZ_FUNCTION virtual void op_RG(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4);
	FZ_FUNCTION virtual void op_rg(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4);
	FZ_FUNCTION virtual void op_K(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5);
	FZ_FUNCTION virtual void op_k(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5);
	FZ_FUNCTION virtual void op_BI(struct ::fz_context *arg_0, struct ::fz_image *arg_2, const char *arg_3);
	FZ_FUNCTION virtual void op_sh(struct ::fz_context *arg_0, const char *arg_2, ::fz_shade *arg_3);
	FZ_FUNCTION virtual void op_Do_image(struct ::fz_context *arg_0, const char *arg_2, struct ::fz_image *arg_3);
	FZ_FUNCTION virtual void op_Do_form(struct ::fz_context *arg_0, const char *arg_2, struct ::pdf_obj *arg_3);
	FZ_FUNCTION virtual void op_MP(struct ::fz_context *arg_0, const char *arg_2);
	FZ_FUNCTION virtual void op_DP(struct ::fz_context *arg_0, const char *arg_2, struct ::pdf_obj *arg_3, struct ::pdf_obj *arg_4);
	FZ_FUNCTION virtual void op_BMC(struct ::fz_context *arg_0, const char *arg_2);
	FZ_FUNCTION virtual void op_BDC(struct ::fz_context *arg_0, const char *arg_2, struct ::pdf_obj *arg_3, struct ::pdf_obj *arg_4);
	FZ_FUNCTION virtual void op_EMC(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_BX(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_EX(struct ::fz_context *arg_0);
	FZ_FUNCTION virtual void op_gs_OP(struct ::fz_context *arg_0, int arg_2);
	FZ_FUNCTION virtual void op_gs_op(struct ::fz_context *arg_0, int arg_2);
	FZ_FUNCTION virtual void op_gs_OPM(struct ::fz_context *arg_0, int arg_2);
	FZ_FUNCTION virtual void op_gs_UseBlackPtComp(struct ::fz_context *arg_0, struct ::pdf_obj *arg_2);
	FZ_FUNCTION virtual void op_END(struct ::fz_context *arg_0);
};
...
struct PdfSanitizeFilterOptions2 : PdfSanitizeFilterOptions
{
	...
	/** Default virtual method implementations; these all throw an exception. */
	FZ_FUNCTION virtual struct ::fz_image * image_filter(struct ::fz_context *arg_0, ::fz_matrix arg_2, const char *arg_3, struct ::fz_image *arg_4);
	FZ_FUNCTION virtual int text_filter(struct ::fz_context *arg_0, int *arg_2, int arg_3, ::fz_matrix arg_4, ::fz_matrix arg_5, ::fz_rect arg_6);
	FZ_FUNCTION virtual void after_text_object(struct ::fz_context *arg_0, struct ::pdf_document *arg_2, struct ::pdf_processor *arg_3, ::fz_matrix arg_4);
	FZ_FUNCTION virtual int culler(struct ::fz_context *arg_0, ::fz_rect arg_2, ::fz_cull_type arg_3);
};
