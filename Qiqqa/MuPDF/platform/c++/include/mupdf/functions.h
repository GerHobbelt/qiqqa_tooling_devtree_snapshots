...
FZ_FUNCTION void ll_fz_begin_structure(::fz_device *dev, ::fz_structure standard, const char *raw, int uid);
...
*/
FZ_FUNCTION ::fz_buffer *ll_fz_compress_ccitt_fax_g3(const unsigned char *data, int columns, int rows);
...
*/
FZ_FUNCTION ::fz_buffer *ll_fz_compress_ccitt_fax_g4(const unsigned char *data, int columns, int rows);
...
/** Extra low-level wrapper for `fz_lookup_metadata()` that returns a std::string and sets
...
error information. */
FZ_FUNCTION std::string ll_fz_lookup_metadata(fz_document *doc, const char *key, int* o_out=NULL);
...
FZ_FUNCTION ::fz_buffer *ll_fz_new_buffer_from_image_as_jpeg(::fz_image *image, ::fz_color_params color_params, int quality);
...
FZ_FUNCTION ::fz_buffer *ll_fz_new_buffer_from_pixmap_as_jpeg(::fz_pixmap *pixmap, ::fz_color_params color_params, int quality);
...
This function has out-params. Python/C# wrappers look like:
	`ll_fz_new_display_list_from_svg(::fz_buffer *buf, const char *base_uri, ::fz_archive *zip)` => `(fz_display_list *, float w, float h)`
*/
/**
	Parse an SVG document into a display-list.
*/
FZ_FUNCTION ::fz_display_list *ll_fz_new_display_list_from_svg(::fz_buffer *buf, const char *base_uri, ::fz_archive *zip, float *w, float *h);

/** Low-level wrapper for `::fz_new_display_list_from_svg_xml()`.

This function has out-params. Python/C# wrappers look like:
	`ll_fz_new_display_list_from_svg_xml(::fz_xml_doc *xmldoc, ::fz_xml *xml, const char *base_uri, ::fz_archive *zip)` => `(fz_display_list *, float w, float h)`
*/
/**
	Parse an SVG document into a display-list.
*/
FZ_FUNCTION ::fz_display_list *ll_fz_new_display_list_from_svg_xml(::fz_xml_doc *xmldoc, ::fz_xml *xml, const char *base_uri, ::fz_archive *zip, float *w, float *h);
...
This function has out-params. Python/C# wrappers look like:
	`ll_fz_new_image_from_compressed_buffer(int w, int h, int bpc, ::fz_colorspace *colorspace, int xres, int yres, int interpolate, int imagemask, ::fz_compressed_buffer *buffer, ::fz_image *mask)` => `(fz_image *, float decode, int colorkey)`
*/
/**
...
*/
FZ_FUNCTION ::fz_image *ll_fz_new_image_from_compressed_buffer(int w, int h, int bpc, ::fz_colorspace *colorspace, int xres, int yres, int interpolate, int imagemask, float *decode, int *colorkey, ::fz_compressed_buffer *buffer, ::fz_image *mask);
...
*/
FZ_FUNCTION ::fz_image *ll_fz_new_image_from_svg(::fz_buffer *buf, const char *base_uri, ::fz_archive *zip);

/** Low-level wrapper for `::fz_new_image_from_svg_xml()`. */
/**
	Create a scalable image from an SVG document.
*/
FZ_FUNCTION ::fz_image *ll_fz_new_image_from_svg_xml(::fz_xml_doc *xmldoc, ::fz_xml *xml, const char *base_uri, ::fz_archive *zip);

/** Low-level wrapper for `::fz_new_image_of_size()`.

This function has out-params. Python/C# wrappers look like:
	`ll_fz_new_image_of_size(int w, int h, int bpc, ::fz_colorspace *colorspace, int xres, int yres, int interpolate, int imagemask, ::fz_image *mask, size_t size, ::fz_image_get_pixmap_fn *get_pixmap, ::fz_image_get_size_fn *get_size, ::fz_drop_image_fn *drop)` => `(fz_image *, float decode, int colorkey)`
*/
/**
...
*/
FZ_FUNCTION ::fz_image *ll_fz_new_image_of_size(int w, int h, int bpc, ::fz_colorspace *colorspace, int xres, int yres, int interpolate, int imagemask, float *decode, int *colorkey, ::fz_image *mask, size_t size, ::fz_image_get_pixmap_fn *get_pixmap, ::fz_image_get_size_fn *get_size, ::fz_drop_image_fn *drop);
...
FZ_FUNCTION ::fz_story *ll_fz_new_story(::fz_buffer *buf, const char *user_css, float em, ::fz_archive *archive);
...
*/
FZ_FUNCTION ::fz_stream *ll_fz_open_dctd(::fz_stream *chain, int color_transform, int l2factor, ::fz_stream *jpegtables);
...
/**
	...
	preserve_white: whether to keep or delete all-whitespace nodes.
*/
FZ_FUNCTION ::fz_xml *ll_fz_parse_xml_archive_entry(::fz_archive *arch, const char *filename, int preserve_white);
...
*/
FZ_FUNCTION ::fz_xml *ll_fz_try_parse_xml_archive_entry(::fz_archive *arch, const char *filename, int preserve_white);
...
FZ_FUNCTION void ll_fz_write_stabilized_story(::fz_document_writer *writer, const char *user_css, float em, ::fz_write_story_contentfn contentfn, void *contentfn_ref, ::fz_write_story_rectfn rectfn, void *rectfn_ref, ::fz_write_story_pagefn pagefn, void *pagefn_ref, ::fz_archive *archive);
...
FZ_FUNCTION ::fz_rect ll_pdf_bound_page(::pdf_page *page);
...
FZ_FUNCTION int ll_pdf_check_signature(::pdf_pkcs7_verifier *verifier, ::pdf_document *doc, ::pdf_obj *signature, char *ebuf, size_t ebufsize);
...
FZ_FUNCTION void ll_pdf_clean_file(char *infile, char *outfile, char *password, ::pdf_write_options *opts, int retainlen, char *retainlist[]);
...
/** Low-level wrapper for `::pdf_format_link_uri()`. */
FZ_FUNCTION char *ll_pdf_format_link_uri(::fz_link_dest dest);
...
/** Low-level wrapper for `::pdf_lookup_anchor()`.

This function has out-params. Python/C# wrappers look like:
	`ll_pdf_lookup_anchor(::pdf_document *doc, const char *name)` => `(int, float xp, float yp)`
*/
FZ_FUNCTION int ll_pdf_lookup_anchor(::pdf_document *doc, const char *name, float *xp, float *yp);
...
/** Extra low-level wrapper for `pdf_lookup_metadata()` that returns a std::string and sets
*o_out to length of string plus one. If <key> is not found, returns empty
string with *o_out=-1. <o_out> can be NULL if caller is not interested in
error information. */
FZ_FUNCTION std::string ll_pdf_lookup_metadata(pdf_document *doc, const char *key, int* o_out=NULL);
...
FZ_FUNCTION ::pdf_processor *ll_pdf_new_buffer_processor(::fz_buffer *buffer, int ahxencode);
...
/** Low-level wrapper for `::pdf_new_destination_from_link()`. */
FZ_FUNCTION ::pdf_obj *ll_pdf_new_destination_from_link(::pdf_document *doc, const char *uri);
...
FZ_FUNCTION ::pdf_processor *ll_pdf_new_output_processor(::fz_output *out, int ahxencode);
...
FZ_FUNCTION ::fz_pixmap *ll_pdf_new_pixmap_from_page_contents_with_separations_and_usage(::pdf_page *page, ::fz_matrix ctm, ::fz_colorspace *cs, ::fz_separations *seps, int alpha, const char *usage);

/** Low-level wrapper for `::pdf_new_pixmap_from_page_contents_with_usage()`. */
FZ_FUNCTION ::fz_pixmap *ll_pdf_new_pixmap_from_page_contents_with_usage(::pdf_page *page, ::fz_matrix ctm, ::fz_colorspace *cs, int alpha, const char *usage);

/** Low-level wrapper for `::pdf_new_pixmap_from_page_with_separations_and_usage()`. */
FZ_FUNCTION ::fz_pixmap *ll_pdf_new_pixmap_from_page_with_separations_and_usage(::pdf_page *page, ::fz_matrix ctm, ::fz_colorspace *cs, ::fz_separations *seps, int alpha, const char *usage);

/** Low-level wrapper for `::pdf_new_pixmap_from_page_with_usage()`. */
FZ_FUNCTION ::fz_pixmap *ll_pdf_new_pixmap_from_page_with_usage(::pdf_page *page, ::fz_matrix ctm, ::fz_colorspace *cs, int alpha, const char *usage);
...
FZ_FUNCTION void ll_pdf_page_obj_transform(::pdf_obj *pageobj, ::fz_rect *page_mediabox, ::fz_matrix *page_ctm);
...
/** Low-level wrapper for `::pdf_parse_link_action()`. */
FZ_FUNCTION char *ll_pdf_parse_link_action(::pdf_document *doc, ::pdf_obj *obj, int pagenum);

/** Low-level wrapper for `::pdf_parse_link_dest()`. */
FZ_FUNCTION char *ll_pdf_parse_link_dest(::pdf_document *doc, ::pdf_obj *obj);

/** Low-level wrapper for `::pdf_parse_link_uri()`. */
FZ_FUNCTION ::fz_link_dest ll_pdf_parse_link_uri(const char *uri);
...
FZ_FUNCTION void ll_pdf_print_encrypted_obj(::fz_output *out, ::pdf_obj *obj, int tight, int ascii, ::pdf_crypt *crypt, int num, int gen);
...
This function has out-params. Python/C# wrappers look like:
	`ll_pdf_process_contents(::pdf_processor *proc, ::pdf_document *doc, ::pdf_obj *obj, ::pdf_obj *res, ::fz_cookie *cookie, ::pdf_obj **out_res)` => 
*/
FZ_FUNCTION void ll_pdf_process_contents(::pdf_processor *proc, ::pdf_document *doc, ::pdf_obj *obj, ::pdf_obj *res, ::fz_cookie *cookie, ::pdf_obj **out_res);
...
FZ_FUNCTION pdf_obj* ll_pdf_dict_getl( pdf_obj* dict, ...);
	...
	/* Helper for calling a fz_document_open_fn. Provides a `fz_context` and coverts
	fz_try..fz_catch exceptions into C++ exceptions. */
	FZ_FUNCTION fz_document* ll_fz_document_open_fn_call(fz_document_open_fn fn, const char* filename);

	/* Helper for calling a fz_document_open_with_stream_fn. Provides a `fz_context` and coverts
	fz_try..fz_catch exceptions into C++ exceptions. */
	FZ_FUNCTION fz_document* ll_fz_document_open_with_stream_fn_call(fz_document_open_with_stream_fn fn, fz_stream* stream);

	/* Helper for calling a fz_document_open_accel_fn. Provides a `fz_context` and coverts
	fz_try..fz_catch exceptions into C++ exceptions. */
	FZ_FUNCTION fz_document* ll_fz_document_open_accel_fn_call(fz_document_open_accel_fn fn, const char* filename, const char* accel);

	/* Helper for calling a fz_document_open_accel_with_stream_fn. Provides a `fz_context` and coverts
	fz_try..fz_catch exceptions into C++ exceptions. */
	FZ_FUNCTION fz_document* ll_fz_document_open_accel_with_stream_fn_call(fz_document_open_accel_with_stream_fn fn, fz_stream* stream, fz_stream* accel);
