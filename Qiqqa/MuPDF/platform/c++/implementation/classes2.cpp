...
FZ_FUNCTION void fz_begin_structure(const FzDevice& dev, ::fz_structure standard, const char *raw, int uid)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	mupdf::ll_fz_begin_structure(dev.m_internal, standard, raw, uid);
}
...
FZ_FUNCTION FzBuffer fz_compress_ccitt_fax_g3(const unsigned char *data, int columns, int rows)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_buffer* temp = mupdf::ll_fz_compress_ccitt_fax_g3(data, columns, rows);
	ll_fz_keep_buffer(temp);
	auto ret = FzBuffer(temp);
	return ret;
}
...
FZ_FUNCTION FzBuffer fz_compress_ccitt_fax_g4(const unsigned char *data, int columns, int rows)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_buffer* temp = mupdf::ll_fz_compress_ccitt_fax_g4(data, columns, rows);
	ll_fz_keep_buffer(temp);
	auto ret = FzBuffer(temp);
	return ret;
}
...
FZ_FUNCTION FzBuffer fz_new_buffer_from_image_as_jpeg(const FzImage& image, const FzColorParams& color_params, int quality)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_buffer* temp = mupdf::ll_fz_new_buffer_from_image_as_jpeg(image.m_internal, * color_params.internal(), quality);
	auto ret = FzBuffer(temp);
	return ret;
}
...
FZ_FUNCTION FzBuffer fz_new_buffer_from_pixmap_as_jpeg(const FzPixmap& pixmap, const FzColorParams& color_params, int quality)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_buffer* temp = mupdf::ll_fz_new_buffer_from_pixmap_as_jpeg(pixmap.m_internal, * color_params.internal(), quality);
	auto ret = FzBuffer(temp);
	return ret;
}
...
/* Class-aware wrapper for `::fz_new_display_list_from_svg()`.
	...
	This function has out-params. Python/C# wrappers look like:
		`fz_new_display_list_from_svg(::fz_buffer *buf, const char *base_uri, ::fz_archive *zip)` => `(fz_display_list *, float w, float h)`
	 */
FZ_FUNCTION FzDisplayList fz_new_display_list_from_svg(const FzBuffer& buf, const char *base_uri, const FzArchive& zip, float *w, float *h)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_display_list* temp = mupdf::ll_fz_new_display_list_from_svg(buf.m_internal, base_uri, zip.m_internal, w, h);
	auto ret = FzDisplayList(temp);
	return ret;
}
...
/* Class-aware wrapper for `::fz_new_display_list_from_svg_xml()`.
	...
	This function has out-params. Python/C# wrappers look like:
		`fz_new_display_list_from_svg_xml(::fz_xml_doc *xmldoc, ::fz_xml *xml, const char *base_uri, ::fz_archive *zip)` => `(fz_display_list *, float w, float h)`
	 */
FZ_FUNCTION FzDisplayList fz_new_display_list_from_svg_xml(const FzXml& xmldoc, const FzXml& xml, const char *base_uri, const FzArchive& zip, float *w, float *h)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_display_list* temp = mupdf::ll_fz_new_display_list_from_svg_xml(xmldoc.m_internal, xml.m_internal, base_uri, zip.m_internal, w, h);
	auto ret = FzDisplayList(temp);
	return ret;
}
...
/* Class-aware wrapper for `::fz_new_image_from_compressed_buffer()`.
	...
	This function has out-params. Python/C# wrappers look like:
		`fz_new_image_from_compressed_buffer(int w, int h, int bpc, ::fz_colorspace *colorspace, int xres, int yres, int interpolate, int imagemask, ::fz_compressed_buffer *buffer, ::fz_image *mask)` => `(fz_image *, float decode, int colorkey)`
	 */
FZ_FUNCTION FzImage fz_new_image_from_compressed_buffer(int w, int h, int bpc, const FzColorspace& colorspace, int xres, int yres, int interpolate, int imagemask, float *decode, int *colorkey, const FzCompressedBuffer& buffer, const FzImage& mask)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION FzImage fz_new_image_from_svg(const FzBuffer& buf, const char *base_uri, const FzArchive& zip)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_image* temp = mupdf::ll_fz_new_image_from_svg(buf.m_internal, base_uri, zip.m_internal);
	auto ret = FzImage(temp);
	return ret;
}
...
FZ_FUNCTION FzImage fz_new_image_from_svg_xml(const FzXml& xmldoc, const FzXml& xml, const char *base_uri, const FzArchive& zip)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_image* temp = mupdf::ll_fz_new_image_from_svg_xml(xmldoc.m_internal, xml.m_internal, base_uri, zip.m_internal);
	auto ret = FzImage(temp);
	return ret;
}
...
/* Class-aware wrapper for `::fz_new_image_of_size()`.
	...
	This function has out-params. Python/C# wrappers look like:
		`fz_new_image_of_size(int w, int h, int bpc, ::fz_colorspace *colorspace, int xres, int yres, int interpolate, int imagemask, ::fz_image *mask, size_t size, ::fz_image_get_pixmap_fn *get_pixmap, ::fz_image_get_size_fn *get_size, ::fz_drop_image_fn *drop)` => `(fz_image *, float decode, int colorkey)`
	 */
FZ_FUNCTION FzImage fz_new_image_of_size(int w, int h, int bpc, const FzColorspace& colorspace, int xres, int yres, int interpolate, int imagemask, float *decode, int *colorkey, const FzImage& mask, size_t size, ::fz_image_get_pixmap_fn *get_pixmap, ::fz_image_get_size_fn *get_size, ::fz_drop_image_fn *drop)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION FzStream fz_open_dctd(const FzStream& chain, int color_transform, int l2factor, const FzStream& jpegtables)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_stream* temp = mupdf::ll_fz_open_dctd(chain.m_internal, color_transform, l2factor, jpegtables.m_internal);
	auto ret = FzStream(temp);
	return ret;
}
...
FZ_FUNCTION FzXml fz_parse_xml_archive_entry(const FzArchive& arch, const char *filename, int preserve_white)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_xml* temp = mupdf::ll_fz_parse_xml_archive_entry(arch.m_internal, filename, preserve_white);
	auto ret = FzXml(temp);
	return ret;
}
...
FZ_FUNCTION FzXml fz_try_parse_xml_archive_entry(const FzArchive& arch, const char *filename, int preserve_white)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_xml* temp = mupdf::ll_fz_try_parse_xml_archive_entry(arch.m_internal, filename, preserve_white);
	ll_fz_keep_xml(temp);
	auto ret = FzXml(temp);
	return ret;
}
...
FZ_FUNCTION void fz_write_stabilized_story(const FzDocumentWriter& writer, const char *user_css, float em, ::fz_write_story_contentfn contentfn, void *contentfn_ref, ::fz_write_story_rectfn rectfn, void *rectfn_ref, ::fz_write_story_pagefn pagefn, void *pagefn_ref, const FzArchive& archive)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	mupdf::ll_fz_write_stabilized_story(writer.m_internal, user_css, em, contentfn, contentfn_ref, rectfn, rectfn_ref, pagefn, pagefn_ref, archive.m_internal);
}
...
FZ_FUNCTION FzRect pdf_bound_page(const PdfPage& page)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_rect temp = mupdf::ll_pdf_bound_page(page.m_internal);
	auto ret = FzRect(&temp);
	return ret;
}
...
FZ_FUNCTION int pdf_check_signature(const PdfPkcs7Verifier& verifier, const PdfDocument& doc, const PdfObj& signature, char *ebuf, size_t ebufsize)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
				<< " calling mupdf::ll_pdf_check_signature()\n";
	}
	#endif
	auto ret = mupdf::ll_pdf_check_signature(verifier.m_internal, doc.m_internal, signature.m_internal, ebuf, ebufsize);
	return ret;
}
...
FZ_FUNCTION void pdf_clean_file(char *infile, char *outfile, char *password, PdfWriteOptions& opts, int retainlen, char *retainlist[])
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION char *pdf_format_link_uri(const FzLinkDest& dest)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
				<< " calling mupdf::ll_pdf_format_link_uri()\n";
	}
	#endif
	auto ret = mupdf::ll_pdf_format_link_uri(*dest.m_internal);
	return ret;
}
...
/* Class-aware wrapper for `::pdf_lookup_anchor()`.
	...
	This function has out-params. Python/C# wrappers look like:
		`pdf_lookup_anchor(::pdf_document *doc, const char *name)` => `(int, float xp, float yp)`
	 */
FZ_FUNCTION int pdf_lookup_anchor(const PdfDocument& doc, const char *name, float *xp, float *yp)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
				<< " calling mupdf::ll_pdf_lookup_anchor()\n";
	}
	#endif
	auto ret = mupdf::ll_pdf_lookup_anchor(doc.m_internal, name, xp, yp);
	return ret;
}
...
FZ_FUNCTION PdfProcessor pdf_new_buffer_processor(const FzBuffer& buffer, int ahxencode)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::pdf_processor* temp = mupdf::ll_pdf_new_buffer_processor(buffer.m_internal, ahxencode);
...
FZ_FUNCTION PdfObj pdf_new_destination_from_link(const PdfDocument& doc, const char *uri)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
				<< " calling mupdf::ll_pdf_new_destination_from_link()\n";
	}
	#endif
	::pdf_obj* temp = mupdf::ll_pdf_new_destination_from_link(doc.m_internal, uri);
	auto ret = PdfObj(temp);
	return ret;
}
...
FZ_FUNCTION PdfProcessor pdf_new_output_processor(const FzOutput& out, int ahxencode)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::pdf_processor* temp = mupdf::ll_pdf_new_output_processor(out.m_internal, ahxencode);
	auto ret = PdfProcessor(temp);
	return ret;
}
...
FZ_FUNCTION FzPixmap pdf_new_pixmap_from_page_contents_with_separations_and_usage(const PdfPage& page, const FzMatrix& ctm, const FzColorspace& cs, const FzSeparations& seps, int alpha, const char *usage)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_pixmap* temp = mupdf::ll_pdf_new_pixmap_from_page_contents_with_separations_and_usage(page.m_internal, * ctm.internal(), cs.m_internal, seps.m_internal, alpha, usage);
	auto ret = FzPixmap(temp);
	return ret;
}
...
FZ_FUNCTION FzPixmap pdf_new_pixmap_from_page_contents_with_usage(const PdfPage& page, const FzMatrix& ctm, const FzColorspace& cs, int alpha, const char *usage)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_pixmap* temp = mupdf::ll_pdf_new_pixmap_from_page_contents_with_usage(page.m_internal, * ctm.internal(), cs.m_internal, alpha, usage);
	auto ret = FzPixmap(temp);
	return ret;
}
...
FZ_FUNCTION FzPixmap pdf_new_pixmap_from_page_with_separations_and_usage(const PdfPage& page, const FzMatrix& ctm, const FzColorspace& cs, const FzSeparations& seps, int alpha, const char *usage)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_pixmap* temp = mupdf::ll_pdf_new_pixmap_from_page_with_separations_and_usage(page.m_internal, * ctm.internal(), cs.m_internal, seps.m_internal, alpha, usage);
	auto ret = FzPixmap(temp);
	return ret;
}
...
FZ_FUNCTION FzPixmap pdf_new_pixmap_from_page_with_usage(const PdfPage& page, const FzMatrix& ctm, const FzColorspace& cs, int alpha, const char *usage)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	::fz_pixmap* temp = mupdf::ll_pdf_new_pixmap_from_page_with_usage(page.m_internal, * ctm.internal(), cs.m_internal, alpha, usage);
	auto ret = FzPixmap(temp);
	return ret;
}
...
FZ_FUNCTION void pdf_page_obj_transform(const PdfObj& pageobj, FzRect& page_mediabox, FzMatrix& page_ctm)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	mupdf::ll_pdf_page_obj_transform(pageobj.m_internal,  page_mediabox.internal(),  page_ctm.internal());
}
...
FZ_FUNCTION char *pdf_parse_link_action(const PdfDocument& doc, const PdfObj& obj, int pagenum)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
				<< " calling mupdf::ll_pdf_parse_link_action()\n";
	}
	#endif
	auto ret = mupdf::ll_pdf_parse_link_action(doc.m_internal, obj.m_internal, pagenum);
	return ret;
}


/* Class-aware wrapper for `::pdf_parse_link_dest()`.  */
FZ_FUNCTION char *pdf_parse_link_dest(const PdfDocument& doc, const PdfObj& obj)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
				<< " calling mupdf::ll_pdf_parse_link_dest()\n";
	}
	#endif
	auto ret = mupdf::ll_pdf_parse_link_dest(doc.m_internal, obj.m_internal);
	return ret;
}
...
FZ_FUNCTION void pdf_print_encrypted_obj(const FzOutput& out, const PdfObj& obj, int tight, int ascii, const PdfCrypt& crypt, int num, int gen)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	mupdf::ll_pdf_print_encrypted_obj(out.m_internal, obj.m_internal, tight, ascii, crypt.m_internal, num, gen);
}
...
/* Class-aware wrapper for `::pdf_process_contents()`.
	...
	This function has out-params. Python/C# wrappers look like:
		`pdf_process_contents(::pdf_processor *proc, ::pdf_document *doc, ::pdf_obj *obj, ::pdf_obj *res, ::fz_cookie *cookie, ::pdf_obj **out_res)` => 
	 */
FZ_FUNCTION void pdf_process_contents(const PdfProcessor& proc, const PdfDocument& doc, const PdfObj& obj, const PdfObj& res, FzCookie& cookie, PdfObj& out_res)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	mupdf::ll_pdf_process_contents(proc.m_internal, doc.m_internal, obj.m_internal, res.m_internal, &cookie.m_internal, &out_res.m_internal);
