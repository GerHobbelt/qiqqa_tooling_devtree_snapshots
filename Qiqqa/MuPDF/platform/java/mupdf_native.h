...
/*
 * Class:     com_artifex_mupdf_fitz_Image
 * Method:    newNativeFromImageData
 * Signature: (Lcom/artifex/mupdf/fitz/ImageData;IIILcom/artifex/mupdf/fitz/ColorSpace;IIIZZ[F[ILcom/artifex/mupdf/fitz/Image;)J
 */
JNIEXPORT jlong JNICALL Java_com_artifex_mupdf_fitz_Image_newNativeFromImageData
  (JNIEnv *, jobject, jobject, jint, jint, jint, jobject, jint, jint, jint, jboolean, jboolean, jfloatArray, jintArray, jobject);
 ...
 * Class:     com_artifex_mupdf_fitz_Image
 * Method:    getImageData
 * Signature: ()Lcom/artifex/mupdf/fitz/ImageData;
 */
JNIEXPORT jobject JNICALL Java_com_artifex_mupdf_fitz_Image_getImageData
  (JNIEnv *, jobject);
...
/* DO NOT EDIT THIS FILE - it is machine generated */
#include <jni.h>
/* Header for class com_artifex_mupdf_fitz_ImageData */

#ifndef _Included_com_artifex_mupdf_fitz_ImageData
#define _Included_com_artifex_mupdf_fitz_ImageData
#ifdef __cplusplus
extern "C" {
#endif
#undef com_artifex_mupdf_fitz_ImageData_TYPE_UNKNOWN
#define com_artifex_mupdf_fitz_ImageData_TYPE_UNKNOWN 0L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_RAW
#define com_artifex_mupdf_fitz_ImageData_TYPE_RAW 1L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_FAX
#define com_artifex_mupdf_fitz_ImageData_TYPE_FAX 2L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_FLATE
#define com_artifex_mupdf_fitz_ImageData_TYPE_FLATE 3L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_LZW
#define com_artifex_mupdf_fitz_ImageData_TYPE_LZW 4L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_RLD
#define com_artifex_mupdf_fitz_ImageData_TYPE_RLD 5L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_BMP
#define com_artifex_mupdf_fitz_ImageData_TYPE_BMP 6L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_GIF
#define com_artifex_mupdf_fitz_ImageData_TYPE_GIF 7L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_JBIG2
#define com_artifex_mupdf_fitz_ImageData_TYPE_JBIG2 8L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_JPEG
#define com_artifex_mupdf_fitz_ImageData_TYPE_JPEG 9L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_JPX
#define com_artifex_mupdf_fitz_ImageData_TYPE_JPX 10L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_JXR
#define com_artifex_mupdf_fitz_ImageData_TYPE_JXR 11L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_PNG
#define com_artifex_mupdf_fitz_ImageData_TYPE_PNG 12L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_PNM
#define com_artifex_mupdf_fitz_ImageData_TYPE_PNM 13L
#undef com_artifex_mupdf_fitz_ImageData_TYPE_TIFF
#define com_artifex_mupdf_fitz_ImageData_TYPE_TIFF 14L
/*
 * Class:     com_artifex_mupdf_fitz_ImageData
 * Method:    finalize
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_artifex_mupdf_fitz_ImageData_finalize
  (JNIEnv *, jobject);

/*
 * Class:     com_artifex_mupdf_fitz_ImageData
 * Method:    newNativeRecognizeFormat
 * Signature: (Lcom/artifex/mupdf/fitz/Buffer;)J
 */
JNIEXPORT jlong JNICALL Java_com_artifex_mupdf_fitz_ImageData_newNativeRecognizeFormat
  (JNIEnv *, jobject, jobject);

/*
 * Class:     com_artifex_mupdf_fitz_ImageData
 * Method:    newNative
 * Signature: (Lcom/artifex/mupdf/fitz/Buffer;Lcom/artifex/mupdf/fitz/ImageData/Params;)J
 */
JNIEXPORT jlong JNICALL Java_com_artifex_mupdf_fitz_ImageData_newNative
  (JNIEnv *, jobject, jobject, jobject);
