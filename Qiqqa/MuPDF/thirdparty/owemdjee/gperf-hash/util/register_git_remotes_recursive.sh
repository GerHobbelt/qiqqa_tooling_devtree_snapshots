...
register_remote .                                                             GerHobbelt                               https://github.com/GerHobbelt/gperf.git                                          $# $@
register_remote .                                                             jwinarske                                https://github.com/jwinarske/gperf.git                                           $# $@
register_remote .                                                             rurban                                   https://github.com/rurban/gperf.git                                              $# $@
register_remote .                                                             savannah-original                        https://git.savannah.gnu.org/git/gperf.git                                       $# $@
register_remote .                                                             snnn                                     https://github.com/snnn/gperf.git                                                $# $@
register_remote .                                                             yakaz                                    https://github.com/yakaz/gperf.git                                               $# $@
register_remote .                                                             yakaz-original                           https://github.com/yakaz/gperf.git                                               $# $@
