...
extern int jpegXL_local_tone_map_main(int argc, const char** argv);
extern int jpegXL_icc_simplify_main(int argc, const char** argv);
extern int jpegXL_cjpegli_main(int argc, const char** argv);
extern int jpegXL_djepgli_main(int argc, const char** argv);
